package com.TwitterClone.ProjectBackend.security.ratelimit;
...
public class RateLimitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (probe.isConsumed()) {
            ...
            EventTelemetry event = new EventTelemetry("Rate Limit IP");
            event.getProperties().put("Suspicious IP ", remoteIpAddress);
